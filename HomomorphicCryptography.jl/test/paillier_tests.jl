@testitem "Paillier - Key Generation" tags=[:paillier, :phe] timeout=30 begin
...
@testitem "Paillier - Encryption Basic Values" tags=[:paillier, :phe] timeout=30 begin
    using HomomorphicCryptography
...
@testitem "Paillier - Encryption Large Values" tags=[:paillier, :phe] timeout=30 begin
    using HomomorphicCryptography
...
@testitem "Paillier - Convenience Functions" tags=[:paillier, :phe, :fast] timeout=20 begin
    using HomomorphicCryptography
